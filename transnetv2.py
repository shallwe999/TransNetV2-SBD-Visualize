...
def main_process(files, weights, visualize, tf_device):
    import sys

    predictions, scenes, program_result = None, None, True
    ...
    return predictions, scenes, program_result
...
def main():
    ...
    parser.add_argument("--cpu", action="store_false", help="use CPU to run TensorFlow")
    parser.add_argument("--gpu", action="store_false", help="use GPU to run TensorFlow")
    ...
    main_process(args.files, args.weights, args.visualize, tf_device)
